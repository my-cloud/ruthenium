...
func NewBlockchain(registry RegistrationsManager, settings infrastructure.SettingsProvider, neighborsManager p2p.NeighborsManager, utxosManager application.UtxosManager, logger log.Logger) *Blockchain {
	blockchain := newBlockchain(nil, registry, settings, neighborsManager, utxosManager, logger)
	return blockchain
}

func newBlockchain(blocks []*ledger.Block, registry RegistrationsManager, settings infrastructure.SettingsProvider, neighborsManager p2p.NeighborsManager, utxosManager application.UtxosManager, logger log.Logger) *Blockchain {
