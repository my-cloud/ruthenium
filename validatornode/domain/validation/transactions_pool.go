...
func NewTransactionsPool(blocksManager application.BlocksManager, settings infrastructure.SettingsProvider, neighborsManager p2p.NeighborsManager, utxosManager application.UtxosManager, validatorAddress string, logger log.Logger) *TransactionsPool {
