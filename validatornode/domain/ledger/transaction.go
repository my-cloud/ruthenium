...
func (transaction *Transaction) VerifySignatures(utxosManager protocol.UtxosManager) error {
...
func (transaction *Transaction) Fee(settings protocol.SettingsProvider, timestamp int64, utxosManager protocol.UtxosManager) (uint64, error) {
