...
func (neighborhood *Neighborhood) Neighbors() []network.NeighborController {
...
func (neighborhood *Neighborhood) Synchronize(int64) {
	...
	neighborsByScore := map[int][]network.NeighborController{}
...
func (neighborhood *Neighborhood) selectOutbounds(neighborsByScore map[int][]network.NeighborController, targetsCount int) []network.NeighborController {
	var keys []int
	...
	var outbounds []network.NeighborController
