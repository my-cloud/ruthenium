...
func Test_HandleTargetsRequest_AddInvalidTargets_AddTargetsNotCalled(t *testing.T) {
	...
	handler := NewHandler(new(application.BlocksManagerMock), nil, neighborsManagerMock, new(application.TransactionsManagerMock), new(application.UtxosManagerMock), new(application.TimeProviderMock), log.NewLoggerMock())
...
func Test_HandleSettingsRequest_ValidRequest_SettingsCalled(t *testing.T) {
	...
	handler := NewHandler(new(application.BlocksManagerMock), expectedSettings, new(p2p.NeighborsManagerMock), new(application.TransactionsManagerMock), new(application.UtxosManagerMock), new(application.TimeProviderMock), log.NewLoggerMock())
	req := gp2p.Data{}
...
func Test_HandleFirstBlockTimestampRequest_ValidRequest_FirstBlockTimestampCalled(t *testing.T) {
	...
	handler := NewHandler(blocksManagerMock, nil, new(p2p.NeighborsManagerMock), new(application.TransactionsManagerMock), new(application.UtxosManagerMock), new(application.TimeProviderMock), log.NewLoggerMock())
	req := gp2p.Data{}
...
func Test_HandleTransactionRequest_AddValidTransaction_AddTransactionCalled(t *testing.T) {
	...
	handler := NewHandler(new(application.BlocksManagerMock), nil, neighborsManagerMock, transactionsManagerMock, new(application.UtxosManagerMock), new(application.TimeProviderMock), log.NewLoggerMock())
	req := gp2p.Data{}
	waitGroup.Add(1)
...
func Test_HandleUtxosRequest_ValidUtxosRequest_UtxosByAddressCalled(t *testing.T) {
	...
	handler := NewHandler(new(application.BlocksManagerMock), nil, new(p2p.NeighborsManagerMock), new(application.TransactionsManagerMock), utxosManagerMock, watchMock, log.NewLoggerMock())
	address := "address"
...
func Test_HandleTransactionsRequest_ValidTransactionsRequest_TransactionsCalled(t *testing.T) {
	...
	handler := NewHandler(new(application.BlocksManagerMock), nil, new(p2p.NeighborsManagerMock), transactionsManagerMock, new(application.UtxosManagerMock), new(application.TimeProviderMock), log.NewLoggerMock())
	req := gp2p.Data{}
