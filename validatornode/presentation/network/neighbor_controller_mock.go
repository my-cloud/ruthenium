...
// Ensure, that NeighborControllerMock does implement NeighborController.
// If this is not the case, regenerate this file with moq.
var _ NeighborController = &NeighborControllerMock{}

// NeighborControllerMock is a mock implementation of NeighborController.
//
//	func TestSomethingThatUsesNeighborController(t *testing.T) {
//
//		// make and configure a mocked NeighborController
//		mockedNeighborController := &NeighborControllerMock{
...
//		}
//
//		// use mockedNeighborController in code that requires NeighborController
//		// and then make assertions.
//
//	}
type NeighborControllerMock struct {
...
func (mock *NeighborControllerMock) AddTransaction(transaction []byte) error {
	if mock.AddTransactionFunc == nil {
		panic("NeighborControllerMock.AddTransactionFunc: method is nil but NeighborController.AddTransaction was just called")
	}
	callInfo := struct {
		Transaction []byte
	}{
...
//
//	len(mockedNeighborController.AddTransactionCalls())
func (mock *NeighborControllerMock) AddTransactionCalls() []struct {
	Transaction []byte
} {
	var calls []struct {
		Transaction []byte
...
func (mock *NeighborControllerMock) GetBlocks(startingBlockHeight uint64) ([]byte, error) {
	if mock.GetBlocksFunc == nil {
		panic("NeighborControllerMock.GetBlocksFunc: method is nil but NeighborController.GetBlocks was just called")
	}
	callInfo := struct {
		StartingBlockHeight uint64
	}{
...
// Check the length with:
//
//	len(mockedNeighborController.GetBlocksCalls())
func (mock *NeighborControllerMock) GetBlocksCalls() []struct {
	StartingBlockHeight uint64
} {
	var calls []struct {
		StartingBlockHeight uint64
...
func (mock *NeighborControllerMock) GetFirstBlockTimestamp() (int64, error) {
	if mock.GetFirstBlockTimestampFunc == nil {
		panic("NeighborControllerMock.GetFirstBlockTimestampFunc: method is nil but NeighborController.GetFirstBlockTimestamp was just called")
	}
	callInfo := struct {
	}{}
...
// Check the length with:
//
//	len(mockedNeighborController.GetFirstBlockTimestampCalls())
func (mock *NeighborControllerMock) GetFirstBlockTimestampCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *NeighborControllerMock) GetSettings() ([]byte, error) {
	if mock.GetSettingsFunc == nil {
		panic("NeighborControllerMock.GetSettingsFunc: method is nil but NeighborController.GetSettings was just called")
	}
	callInfo := struct {
	}{}
...
// Check the length with:
//
//	len(mockedNeighborController.GetSettingsCalls())
func (mock *NeighborControllerMock) GetSettingsCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *NeighborControllerMock) GetTransactions() ([]byte, error) {
	if mock.GetTransactionsFunc == nil {
		panic("NeighborControllerMock.GetTransactionsFunc: method is nil but NeighborController.GetTransactions was just called")
	}
	callInfo := struct {
	}{}
...
// Check the length with:
//
//	len(mockedNeighborController.GetTransactionsCalls())
func (mock *NeighborControllerMock) GetTransactionsCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *NeighborControllerMock) GetUtxos(address string) ([]byte, error) {
	if mock.GetUtxosFunc == nil {
		panic("NeighborControllerMock.GetUtxosFunc: method is nil but NeighborController.GetUtxos was just called")
	}
	callInfo := struct {
		Address string
	}{
...
// Check the length with:
//
//	len(mockedNeighborController.GetUtxosCalls())
func (mock *NeighborControllerMock) GetUtxosCalls() []struct {
	Address string
} {
	var calls []struct {
		Address string
...
func (mock *NeighborControllerMock) SendTargets(targets []string) error {
	if mock.SendTargetsFunc == nil {
		panic("NeighborControllerMock.SendTargetsFunc: method is nil but NeighborController.SendTargets was just called")
	}
	callInfo := struct {
		Targets []string
	}{
...
// Check the length with:
//
//	len(mockedNeighborController.SendTargetsCalls())
func (mock *NeighborControllerMock) SendTargetsCalls() []struct {
	Targets []string
} {
	var calls []struct {
		Targets []string
...
func (mock *NeighborControllerMock) Target() string {
	if mock.TargetFunc == nil {
		panic("NeighborControllerMock.TargetFunc: method is nil but NeighborController.Target was just called")
	}
	callInfo := struct {
	}{}
...
// Check the length with:
//
//	len(mockedNeighborController.TargetCalls())
func (mock *NeighborControllerMock) TargetCalls() []struct {
} {
	var calls []struct {
	}
