...
func (transaction *Transaction) VerifySignatures(utxosManager domain.UtxosManager) error {
...
func (transaction *Transaction) Fee(settings validatornode.SettingsProvider, timestamp int64, utxosManager domain.UtxosManager) (uint64, error) {
