...
func (transaction *Transaction) VerifySignatures(utxoFinder validatornode.UtxoFinder) error {
...
func (transaction *Transaction) Fee(settings validatornode.Settings, timestamp int64, utxoFinder validatornode.UtxoFinder) (uint64, error) {
