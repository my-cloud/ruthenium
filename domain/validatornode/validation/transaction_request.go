...
func NewTransactionRequest(transaction *domain.Transaction, transactionBroadcasterTarget string) *TransactionRequest {
...
func (request *TransactionRequest) Transaction() *domain.Transaction {
