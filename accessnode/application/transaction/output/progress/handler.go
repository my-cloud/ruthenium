...
import (
	...
	"github.com/my-cloud/ruthenium/accessnode/application/transaction/output"
...
func NewHandler(host network.NeighborController, settings application.SettingsProvider, watch protocol.TimeProvider, logger log.Logger) *Handler {
