...
func (transaction *Transaction) VerifySignatures(utxosManager application.UtxosManager) error {
...
func (transaction *Transaction) Fee(settings infrastructure.SettingsProvider, timestamp int64, utxosManager application.UtxosManager) (uint64, error) {
